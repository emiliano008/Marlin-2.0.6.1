...
#define CUSTOM_MACHINE_NAME "3D Printer MIP"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79, 79,3850,650 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 160, 160, 2, 100 }

#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 2000,2000,20,1000 } // ...or, set your own edit limits
#endif
...
#define HOMING_FEEDRATE_Z  (8*60) //original 8*60
